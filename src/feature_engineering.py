"""
Code Summary : This feature engineering pipeline converts raw telematics data into a driver-centric dataset for classification.
             It aggregates time-series signals, engineers composite safety scores, and operationalizes business logic for the target
             variable. The pipeline enhances robustness by injecting noise, synthesizing edge cases, and applying SMOTE-ENN for class
             balancing.
"""
...
class TelematicsFeatureEngineer:
    ...
    def create_features_from_raw_data(self, df):
        """Aggregates trip-level data into driver-level features."""
        driver_features = []
    ...
    def process_complete_pipeline(self, raw_data_path="data/telematics_data.csv"):
        ...
        if not os.path.exists(raw_data_path):
            ...
            print("Please generate data first using data_simulator.py\n")
            return None, None
